...
class Soliloquy_Posttype_Admin {
	...
	public function __construct() {
		...
		$this->metabox = Soliloquy_Metaboxes::get_instance();
	...
	public function soliloquy_columns( $columns ) {
		...
		$soliloquy_columns = array(
			...
			'image'     => esc_attr__( '', 'soliloquy' ),
			'title'     => esc_attr__( 'Title', 'soliloquy' ),
			'shortcode' => esc_attr__( 'Shortcode', 'soliloquy' ),
			'modified'  => esc_attr__( 'Last Modified', 'soliloquy' ),
			'date'      => esc_attr__( 'Date', 'soliloquy' ),
		);
		...
		switch ( $column ) {
			...
			*/
			case 'shortcode':
				...
				echo '<a class="soliloquy-clipboard" href="#" data-clipboard-target="#soliloquy-shortcode-' . $post_id . '"">' . esc_attr__( 'Copy to clipboard', 'soliloquy' ) . '</a>';
			...
			*/
			case 'template':
				...
				echo '<a class="soliloquy-clipboard" href="#" data-clipboard-target="#soliloquy-code-' . $post_id . '"">' . esc_attr__( 'Copy to clipboard', 'soliloquy' ) . '</a>';
				break;
	...
	public function messages( $messages ) {
		...
		$messagesArr           = array(
			0  => '',
			1  => esc_attr__( 'Soliloquy slider updated.', 'soliloquy' ),
			2  => esc_attr__( 'Soliloquy slider custom field updated.', 'soliloquy' ),
			3  => esc_attr__( 'Soliloquy slider custom field deleted.', 'soliloquy' ),
			4  => esc_attr__( 'Soliloquy slider updated.', 'soliloquy' ),
			5  => isset( $_GET['revision'] ) ? sprintf( esc_attr__( 'Soliloquy slider restored to revision from %s.', 'soliloquy' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6  => esc_attr__( 'Soliloquy slider published.', 'soliloquy' ),
			7  => esc_attr__( 'Soliloquy slider saved.', 'soliloquy' ),
			8  => esc_attr__( 'Soliloquy slider submitted.', 'soliloquy' ),
			9  => sprintf( esc_attr__( 'Soliloquy slider scheduled for: <strong>%1$s</strong>.', 'soliloquy' ), date_i18n( esc_attr__( 'M j, Y @ G:i' ), strtotime( $post->post_date ) ) ),
			10 => esc_attr__( 'Soliloquy slider draft updated.', 'soliloquy' ),
		);
