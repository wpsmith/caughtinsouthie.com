...
/**
 * Metabox featured area
 *
 */
function ea_metabox_featured_area() {
	$output = array();
	$terms = get_terms( array( 'taxonomy' => 'featured_area' ) );
