...
class SearchWP {
	...
	function init() {
		...
		// Implement debugging if applicable.
		$advanced_settings_ref     = get_option( SEARCHWP_PREFIX . 'advanced' );
		$debugging_setting_enabled = ! empty( $advanced_settings_ref['debugging'] );
		if ( $debugging_setting_enabled ) {
			$this->init_debugging();
		}
