...
class SearchWP_Metrics_i18n {
	...
	function __construct() {
		$this->strings = array(
			...
			'ip_blacklist' => esc_html__( 'IP Blacklist', 'searchwp-metrics' ),
			'ip_blacklist_note' => esc_html__( 'One per line. Searches from these IPs will be ignored.', 'searchwp-metrics' ),
			'logging_rules' => esc_html__( 'Logging Rules', 'searchwp-metrics' ),
			'logging_rules_note' => esc_html__( 'Logging can be prevented by customizing the IP Blacklist and User ID/Role Blacklist below. Searches that meet the criteria of either Blacklist will not be logged.', 'searchwp-metrics' ),
			...
			'user_id_role_blacklist' => esc_html__( 'User ID/Role Blacklist', 'searchwp-metrics' ),
			'user_id_role_blacklist_note' => esc_html__( 'One per line. Searches from these IDs/Roles will be ignored.', 'searchwp-metrics' ),
