			...
			<vue-modaltor
				...
				<div class="searchwp-metrics__modal searchwp-metrics__modal-logging">
					...
					<div class="searchwp-metrics__textarea">
						<label for="searchwp_metrics_ip_blacklist">{{ i18n.userIdRoleBlacklist }}</label>
						<textarea v-model="ignoredRoles" name="searchwp_metrics_role_blacklist" id="searchwp_metrics_role_blacklist" cols="30" rows="10"></textarea>
						<p class="description">{{ i18n.userIdRoleBlacklistNote }}</p>
					</div>
					<div class="searchwp-metrics__textarea">
						<label for="searchwp_metrics_ip_blacklist">{{ i18n.ipBlacklist }}</label>
						<textarea v-model="ignoredIps" name="searchwp_metrics_ip_blacklist" id="searchwp_metrics_ip_blacklist" cols="30" rows="10"></textarea>
						<p class="description">{{ i18n.ipBlacklistNote }}</p>
					</div>
					<ul class="searchwp-metrics__modal-confirmation--actions">
						<li>
...
export default {
	...
	data () {
		...
		return {
			...
			inlineIgnores: [],
			ignoredIps: _SEARCHWP_METRICS_VARS.settings.blacklists.ips,
			ignoredRoles: _SEARCHWP_METRICS_VARS.settings.blacklists.roles,
			sameDate: false,
			...
			i18n: {
				...
				ipBlacklist: _SEARCHWP_METRICS_VARS.i18n.ip_blacklist,
				ipBlacklistNote: _SEARCHWP_METRICS_VARS.i18n.ip_blacklist_note,
				...
				userIdRoleBlacklist: _SEARCHWP_METRICS_VARS.i18n.user_id_role_blacklist,
				userIdRoleBlacklistNote: _SEARCHWP_METRICS_VARS.i18n.user_id_role_blacklist_note,
