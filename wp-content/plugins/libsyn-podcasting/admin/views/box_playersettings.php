		...
		<tr valign="top">
			...
			<td>
				<div>
					...
					<br />
					<div>
						<input id="player_use_theme_custom" type="radio" value="custom" name="player_use_theme" /><span style="margin-left:16px;"><strong>Custom</strong>&nbsp;&nbsp;<em style="font-weight:300;">(minimum height 90px or 300px(video), width 450px)</em></span>
			...
			<td>
				<div>
					<div style="margin-left:36px;">
						<input id="player_custom_color" class="color-picker" name="player_custom_color" value=""/><button type="button" class="button" data-editor="content" font="400 18px/1 dashicons" id="player_custom_color_picker_button"><span class="dashicons libsyn-dashicons-art" style="padding-top: 4px;"></span> Pick Color</button>
