...
class Integration extends \Libsyn\Service {
	...
	public function checkPlugin($plugin_name) {
		...
		if(file_exists($this->wp_base_dir . 'wp-admin' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'plugin.php')) {
			include_once( $this->wp_base_dir . 'wp-admin' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'plugin.php' );
		} elseif(file_exists( ABSPATH . 'wp-admin' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'plugin.php')) { //try abspath
