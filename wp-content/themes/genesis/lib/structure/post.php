...
function genesis_numeric_posts_nav() {
	...
	$before_number = genesis_a11y( 'screen-reader-text' ) ? '<span class="screen-reader-text">' . __( 'Go to page', 'genesis' ) . '</span>' : '';
	...
	if ( get_previous_posts_link() ) {
		...
		printf( '<li class="pagination-previous">%s</li>' . "\n", get_previous_posts_link( apply_filters( 'genesis_prev_link_text', '&#x000AB; ' . __( '<span class="screen-reader-text">Go to</span> Previous Page', 'genesis' ) ) ) );
	}
	...
	if ( ! in_array( $max, $links, true ) ) {
		...
		if ( ! in_array( $max - 1, $links, true ) ) {
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Value is known to be safe, not set via input.
			printf( '<li class="pagination-omission"><span class="screen-reader-text">%s </span>&#x02026;</li> ' . "\n", __( 'Interim page numbers omitted', 'genesis' ) );
		}
	...
	if ( get_next_posts_link() ) {
		...
		printf( '<li class="pagination-next">%s</li> ' . "\n", get_next_posts_link( apply_filters( 'genesis_next_link_text', __( '<span class="screen-reader-text">Go to</span> Next Page', 'genesis' ) . ' &#x000BB;' ) ) );
	}
